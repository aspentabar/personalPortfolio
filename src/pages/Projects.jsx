...
export function Projects() {
  ...
  return (
    <section className="w-full overflow-x-hidden pt-16 pb-12 md:py-20">
      {isMobile ? (
        // Mobile version - no RevealOnScroll
        <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10">
            {filtered.map((proj, i) => (
              <div
                key={proj.id}
                className={`w-full rounded-xl sm:rounded-2xl bg-white shadow overflow-hidden flex flex-col sm:animate-fadeIn ${
        ...
        // Desktop/Tablet version - with RevealOnScroll
        <RevealOnScroll>
          <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mt-8 sm:mt-6 md:mt-10" />
            <div className="mb-2">
